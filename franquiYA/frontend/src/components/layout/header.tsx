    ...
    <header className="sticky top-0 z-30 border-b border-[#E8DFD3] bg-white/80 backdrop-blur-sm">
      <div className="flex h-16 items-center justify-between px-6">
        <div className="flex items-center gap-4">
          <h2 className="text-lg font-semibold text-[#4A3728] font-heading">
        ...
        <div className="flex items-center gap-4">
          {loading ? (
            ...
            <div className="flex items-center gap-4">
              <Card className="border-[#E8DFD3] bg-[#FEF3E2]">
                <CardContent className="flex items-center gap-3 px-4 py-2">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      <Thermometer className="h-4 w-4 text-[#8B7355]" />
                      <span className="text-lg font-bold text-[#4A3728]">{Math.round(weather.temp)}°C</span>
              ...
              {insight && (
                <Card className={`mt-2 border-2 ${insight.bgColor} ${insight.borderColor}`}>
                  <CardContent className="flex items-center gap-3 px-4 py-2">
                    <span className="text-2xl">{insight.icon}</span>
                    <div className="flex flex-col">
                      <span className="text-sm font-semibold text-[#4A3728]">{insight.message}</span>
                      <span className="text-xs text-[#8B7355]">{insight.action}</span>
                    </div>
                  </CardContent>
                </Card>
              )}
